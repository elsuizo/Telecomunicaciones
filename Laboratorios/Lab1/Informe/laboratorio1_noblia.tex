...
\rhead{\includegraphics[width=.075\textwidth]{./Images/logo_iaci2.eps}}
\chead{}
...
\end{itemize}
\subsection{resolución}
El modulo en donde guardamos las funciones es \textit{teleco2.jl} que utilizamos posteriormente en 
